...
- **Схема подключения групп помещений:** Общий АВДТ TOSMR1 на DIN-рейке → Блок АВДТ TOSMR1 для отдельных помещений → Двухполюсные автоматические выключатели (например, ABB 2P ACB) для конечных групп → Клеммы WAGO (например, 285-1102) для подключения. ![пример](electrical/electrical_panel.png)
